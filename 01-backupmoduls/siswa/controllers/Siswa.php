...
function reportSiswa($idsiswa='',$idpengguna='') {
    ...
    if ($this->get_status_login()&& $hak_akses=="admin") {   
        if ($idpengguna == 0) {
            ...
            $data['judul_halaman'] = "Report Siswa".'  <a class="btn  btn-sm btn-warning"  title="Edit" href="' . base_url('index.php/siswa/updateSiswa/' . $idsiswa . '/' . $idpengguna) . '" "><i class="ico-edit"></i></a> 
';
            $data['files'] = array(

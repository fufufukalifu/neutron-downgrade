						...
						<nav class="main-nav">
							...
							<ul class="clear-fix">
								...
								<li>
									...
									<a href="<?=base_url('index.php/modulonline/allmodul') ?>">Modul</a>
                                                                         <ul>

										<li><a href="<?=base_url('index.php/modulonline/modulsd') ?>">Modul SD</a></li>
										<li><a href="<?=base_url('index.php/modulonline/modulsmp') ?>">Modul SMP</a></li>
										<li><a href="<?=base_url('index.php/modulonline/modulsma') ?>">Modul SMA</a></li>
										<li><a href="<?=base_url('index.php/modulonline/modulsmaipa') ?>">Modul SMA - IPA</a></li>
										<li><a href="<?=base_url('index.php/modulonline/modulsmaips') ?>">Modul SMA - IPS</a></li>
									</ul>

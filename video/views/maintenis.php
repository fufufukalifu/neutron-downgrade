...
<body>
  ...
  <div class="page-content container clear-fix">
      <div class="container-404">
          <div class="number">c<span>i</span>Aa!!</div>
          <p><span>Sorry:(</span><br>Kita sedang maintenis harap bersabar ini adalah Bulan Ramadhan</p>
          <a href="<?=base_url()?>logout" class="cws-button border-radius alt">Silahkan lanjutkan ke halaman utama kita.</a>
          </div>
  </div>

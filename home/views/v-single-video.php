                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 mb15">
                            ...
                            <article class="panel panel-minimal overflow-hidden">
                                <!-- Owl Carousel -->
                                <header id="gallery-post" class="owl-carousel">
                                    <div class="image"><img src="<?=base_url('assets/image/background/blog/blog4.jpg');?>"></div>
                                    <div class="image"><img src="<?=base_url('assets/image/background/blog/blog3.jpg');?>"></div>
                                    <div class="image"><img src="<?=base_url('assets/image/background/blog/blog5.jpg');?>"></div>
                                </header>
                                <!--/ Owl Carousel -->
                                ...
                                <section class="panel-body pl0 pr0">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 col-sm-11 col-md-11">
                                            <!-- heading -->
                                            <h3 class="font-alt ellipsis mt0"><a href="javascript:void(0);" class="text-default">Pellentesque tincidunt tempus risus. Donec egestas. Duis ac</a></h3>
                                            <!--/ heading -->

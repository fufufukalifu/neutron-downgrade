    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h5 class="panel-title">Daftar Matapelajaran</h5>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah Data Matapelajaran</h4>
            ...
            <form action="<?= base_url('index.php/admin/tambahMP') ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input name="namaMP" type="text" class="form-control" placeholder="Nama Matapelajaran" required> <br>

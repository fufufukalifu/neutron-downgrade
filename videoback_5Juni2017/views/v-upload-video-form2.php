      ...
      $(function()
  {
      $(document).on('click', '.btn-add', function(e)
      {
          ...
          controlForm.find('.entry:not(:last) .btn-add')
              ...
              .html('<span class="glyphicon glyphicon-minus"></span> Remove Form '+z);
          //ganti judul form clone ke n
          controlForm.find('.entry:not(:last) .headF')
          .removeClass('headF').addClass('headF'+z)
          .html('<h5>Form Upload Video '+z+'</h5>');
          // ganti name input tingkat => tingkat+z
          controlForm.find('.entry:not(:last) [name=tingkat]')
          .attr('name','tingkat'+z)
          .attr('id','tingkat'+z)
          .attr('onchange','ev_tingkat('+z+')');
          // ganti name input mapel => mapel+z
          controlForm.find('.entry:not(:last) [name=mataPelajaran]')
          .attr('name','mataPelajaran'+z)
          .attr('id','pelajaran'+z)
           .attr('onchange','ev_pelajaran('+z+')');
          // ganti name input bab => bab+z
          controlForm.find('.entry:not(:last) [name=bab]')
          .attr('name','bab'+z)
          .attr('id','bab'+z)
           .attr('onchange','ev_bab('+z+')');;
          // ganti name input subBab => subBab+z
          ...
          .attr('id','filetype'+z);
          // #VIDEO
          // ubah name input option_up => option_up+z
          controlForm.find('.entry:not(:last) .op_server [name=option_up]')
          .attr('name','option_up'+z)
          .val('server');
          ...
          .attr('for','filethumbnail'+z);
          // ubah id filethumbnail
          controlForm.find('.entry:not(:last) #filethumbnail')
          .attr('id','filethumbnail'+z)
          .attr('onchange','fileThumbnail(this,'+z+')')
          ;
          // /thumbnail

          // ubah name input video => video+z
          controlForm.find('.entry:not(:last) [name=video]')
          .attr('name','video'+z);

          // ubah name input jenis_video => jenis_video+z
          controlForm.find('.entry:not(:last) [name=jenis_video]')
          .attr('name','jenis_video'+z);
          // ubah name input judulvideo => judulvideo+z
          controlForm.find('.entry:not(:last) [name=judulvideo]')
          .attr('name','judulvideo'+z);
          // ubah name input deskripsi => deskripsi+z
          controlForm.find('.entry:not(:last) [name=deskripsi]')
          .attr('name','deskripsi'+z);
          // ubah name input publish => publish+z
          controlForm.find('.entry:not(:last) [name=publish]')
          .attr('name','publish'+z);
          controlForm.find('#ProgressBarDownload')
          .attr('id','ProgressBarDownload'+z);
          // btnf
           controlForm.find('.entry:not(:last) .btnf')
           .removeClass('btnf')
          .attr('onclick','upvideo('+z+')');

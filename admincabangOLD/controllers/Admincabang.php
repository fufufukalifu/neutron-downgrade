...
//laporan to ajax
	...
	public function get_siswa_regist_parti($id_tryout,$cabangID='all'){
		...
		$jumlah = $datas['daftar']-$datas['ikutan'];
		$array[] = ['label'=>"Partisipasi : ".$datas['ikutan'],  "y"=>(int)$datas['ikutan']];
		$array[] = ['label'=>"Tidak Berpartisipasi : ".$jumlah,  "y"=>(int)$datas['daftar']-$datas['ikutan']];
